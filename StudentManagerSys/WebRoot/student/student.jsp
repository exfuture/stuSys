...
<table border="1" cellspacing="1" cellpadding="2" class="bgtable" align="center" style="table-layout:fixed" width="100%">
	<TR  align="center">
		<TD width="45%">Ñ§ÉúÐÕÃû</TD><td width="45%">Ñ§Éú¼Ó¿Û·ÖÇé¿ö</td><td width="10%">Ñ§Éúµ±Ç°×Ü·Ö</td>
	</TR>	
	...
	<TR  align="center" bgcolor="yellow">
		...
		<TD>
		<a href="<%=request.getContextPath()%>/student!getStudentSituation.action?stuNo=<%=stuList.get(i).getStuNo() %>">²éÑ¯</a></TD>
