...
<script type="text/javascript">
	...
	function cut(cut,reason) {
		...
		if(cDate.value==""){
		    ...
		    {	//Èç¹ûÊÇtrue £¬
				...
				var url = "student!cut.action?stuNo="+stuNo+"&chooseDate="+cDate.value+"&cut="+cut+"&reason="+reason;
	...
	function cut1(ca,name,reason) {
		...
		if(cDate.value==""){
		    ...
		    {	//Èç¹ûÊÇtrue £¬
		    	var stuNo=document.getElementById("stuNo").value;	   	
				var url = "student!cut.action?stuNo="+stuNo+"&chooseDate="+cDate.value+"&cut="+ca+caScore.value+"&reason="+reason;
				window.location.href = url;
		     }
   		 	else
		    {
...
<body>
<input type="hidden" id="stuNo" name="stuNo" value="<s:property value="stu.stuNo" />">
...
<table width="866" border="1">
  ...
  <tr>
    ...
    <td width="154"><s:property value="stu.stuName" />   </td>
    <td width="73"><p>ÉÏÑ§ÆÚ</p>
    <p>³É¼¨ÅÅÃû¼°³É¼¨</p></td>
    <td width="159">°à¼¶ÅÅÃû<s:property value="stu.lastTermRank" /> </td>
  ...
  <tr>
    ...
    <td rowspan="28"><s:property value="stu.studentScore" /></td>
  </tr>
  <tr>
