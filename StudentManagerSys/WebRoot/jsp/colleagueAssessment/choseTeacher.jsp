	...
	<table width="900" border=0 cellpadding=0 cellspacing=7 class="norepeat">
		<tr height="21">
			...
			<td  height="21" align="left" valign="middle">
				...
				<span class="pagetitle">Ñ¡ÔñÒªÆÀ¼ÛµÄ½ÌÊ¦</span>
			</td>
			
	</table>
	<br><br><br>
<form action="<%=request.getContextPath() %>/colleagueAssessment!queryColleagueLessons.action" method="post">
	<table width="80%" bgcolor="#55AAEE" align="center">
		<tr align="center" valign="middle" height="28">	
			<td align="center" class="tabletitle">ÊäÈë½ÌÊ¦±àºÅ</td>
		</tr>		
		<tr >
