...
<script type="text/javascript">
		...
		{
			alert("评价成功");
			var url="expertAssessment!over.action";
			window.location.href=url;
		}
		//鼠标离开时的背景颜色
	...
	<table width="900" border=0 cellpadding=0 cellspacing=7 class="norepeat">
		<tr height="21">
			...
			<td  height="21" align="left" valign="middle">
				...
				<span class="pagetitle">专家评价</span>
			</td>
...
<br><br>
<!--按钮区域 -->
<form action="<%=request.getContextPath()%>/expertAssessment!over.action"
...
<input type=hidden name=contextPath value="<%=request.getContextPath()%>" /> <!--标题行和数据行 -->
  <table id="workItemList" width="80%" bgcolor="#55AAEE" align="center">
    ...
    <tr align="center" valign="middle" height="28">
      ...
      <td  align="center" class="tabletitle">讲授得分</td>
