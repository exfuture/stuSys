...
<body>
	...
	<table width="900" border=0 cellpadding=0 cellspacing=7 class="norepeat">
		<tr height="21">
			...
			<td  height="21" align="left" valign="middle">
				...
				<span class="pagetitle">×¨¼ÒÆÀ¼Û</span>
			</td>			
		</tr>
	</table>
	<br><br>
	<table width="80%" bgcolor="#55AAEE" align="center">
		...
		<s:if test="expertLessonList!=null">
		<s:iterator id="point"value="expertLessonList">			
		<tr >
			<td bgcolor="#FFFFFF" align="center">
				<s:property value="lesson.LESSONNAME"/>
			</td>					
			<td bgcolor="#FFFFFF" align="center">
				<a href="<%=request.getContextPath()%>/expertAssessment!chosePoints.action?lessonId=<s:property value="lesson.LESSONCODE"/>">ÆÀ¼Û</a>
			</td> 
		</tr>
		</s:iterator>	
		</s:if>
