...
<body>
	...
	<table width="900" border=0 cellpadding=0 cellspacing=7 class="norepeat">
		<tr height="21">
			...
			<td  height="21" align="left" valign="middle">
				...
				<span class="pagetitle">½ÌÑ§ÖÊÁ¿ÆÀ¹ÀÏµÍ³&nbsp;>&nbsp;Ñ§ÉúÆÀ¼Û</span>
			</td>			
		</tr>
	</table>
	<br><br>
	<table width="80%" bgcolor="#55AAEE" align="center">
		...
		<s:if test="studentLessonList!=null">
		<s:iterator id="point"value="studentLessonList">			
		<tr >
			<td bgcolor="#FFFFFF" align="center">
				<s:property value="lesson.LESSONNAME"/>
			</td>					
			<td bgcolor="#FFFFFF" align="center">
				<a href="<%=request.getContextPath()%>/studentAssessment!chosePoints.action?lessonId=<s:property value="lesson.LESSONCODE"/>">ÆÀ¼Û</a>
			</td> 
		</tr>
		</s:iterator>	
		</s:if>
