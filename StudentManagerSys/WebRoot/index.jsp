...
<FRAMESET frameSpacing=0 rows=92,* frameBorder=NO>
	...
	<FRAMESET id=bbsArea name=main frameSpacing=0 frameBorder=NO cols=200,9,*>
		<FRAMESET id=_leftAll name=leftAll frameSpacing=0 rows=27,*,37 frameBorder=NO>
			...
			<FRAME id=_leftdown name=leftdown src="frame/left3.htm" scrolling=no target="right" noresize>
		</FRAMESET>
			<FRAME name=control src="frame/control.htm" scrolling=no>
