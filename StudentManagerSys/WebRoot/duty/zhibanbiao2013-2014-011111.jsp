...
<TABLE WIDTH=775 BORDER=0 CELLPADDING=0 CELLSPACING=0>
    ...
    <!-- 班级编号传值 -->
	<input type="hidden"  name="classDutyList[0].classNo" value="1102" size="5">
    ...
    <input type="hidden"  name="classDutyList[4].classNo" value="1301" size="5">
    <input type="hidden"  name="classDutyList[5].classNo" value="1302" size="5">
    <input type="hidden"  name="classDutyList[6].classNo" value="1303" size="5">
	<input type="hidden"  name="classDutyList[7].classNo" value="1402" size="5">
    <!-- 班级名称传值 -->
	<input type="hidden"  name="classDutyList[0].className" value="2011级3+2" size="5">
    ...
    <input type="hidden"  name="classDutyList[4].className" value="2013级大专" size="5">
    <input type="hidden"  name="classDutyList[5].className" value="2013级3+2" size="5">
    <input type="hidden"  name="classDutyList[6].className" value="2013级中专" size="5">
	<input type="hidden"  name="classDutyList[7].className" value="2014级3+2" size="5">
	<!-- 应出勤人数传值 -->    
	<input type="hidden"  name="classDutyList[0].ycq" value="27" size="5">
    ...
    <input type="hidden"  name="classDutyList[4].ycq" value="44" size="5">
    <input type="hidden"  name="classDutyList[5].ycq" value="22" size="5">
    <input type="hidden"  name="classDutyList[6].ycq" value="15" size="5">
...
<table width="100%" height="764" border="1">
  ...
  <tr>
    ...
    <td width="74" align="center" valign="middle">2011（3+2）</td>
    ...
    <td width="79" align="center" valign="middle">2013大专</td>
    <td width="80" align="center" valign="middle">2013（3+2）</td>
    <td width="77" align="center" valign="middle">2013中专</td>
  ...
  <tr align="center" valign="middle">
    <td>实出勤</td>
    <td><input type="text" id="1102scq" name="classDutyList[0].scq" size="5"></td>
    <td><input type="text" id="1401scq" name="classDutyList[1].scq" size="5"></td>
    <td><input type="text" id="1202scq" name="classDutyList[2].scq" size="5"></td>
    <td><input type="text" id="1403scq" name="classDutyList[3].scq" size="5"></td>
    <td><input type="text" id="1301scq" name="classDutyList[4].scq" size="5"></td>
    <td><input type="text" id="1302scq" name="classDutyList[5].scq" size="5"></td>
    <td><input type="text" id="1303scq" name="classDutyList[6].scq" size="5"></td>
	<td><input type="text" id="1402scq" name="classDutyList[7].scq" size="5"></td>
  </tr>
  <tr align="center" valign="middle">
    <td>选修</td>
    <td><input type="text" id="1102xx" name="classDutyList[0].xx" size="5"></td>
    <td><input type="text" id="1401xx" name="classDutyList[1].xx" size="5"></td>
    <td><input type="text" id="1202xx" name="classDutyList[2].xx" size="5"></td>
    <td><input type="text" id="1403xx" name="classDutyList[3].xx" size="5"></td>
    <td><input type="text" id="1301xx" name="classDutyList[4].xx" size="5"></td>
    <td><input type="text" id="1302xx" name="classDutyList[5].xx" size="5"></td>
    <td><input type="text" id="1303xx" name="classDutyList[6].xx" size="5"></td>
    <td><input type="text" id="1402xx" name="classDutyList[7].xx" size="5"></td>	
  </tr>
  <tr align="center" valign="middle">
    <td>事假</td>
    <td><input type="text" id="1102sj" name="classDutyList[0].sj" size="5"></td>
    <td><input type="text" id="1401sj" name="classDutyList[1].sj" size="5"></td>
    <td><input type="text" id="1202sj" name="classDutyList[2].sj" size="5"></td>
    <td><input type="text" id="1403sj" name="classDutyList[3].sj" size="5"></td>
    <td><input type="text" id="1301sj" name="classDutyList[4].sj" size="5"></td>
    <td><input type="text" id="1302sj" name="classDutyList[5].sj" size="5"></td>
    <td><input type="text" id="1303sj" name="classDutyList[6].sj" size="5"></td> 
    <td><input type="text" id="1402sj" name="classDutyList[7].sj" size="5"></td>
  </tr>
  <tr align="center" valign="middle">
    <td>病假</td>
    <td><input type="text" id="1102bj" name="classDutyList[0].bj" size="5"></td>
    <td><input type="text" id="1401bj" name="classDutyList[1].bj" size="5"></td>
    <td><input type="text" id="1202bj" name="classDutyList[2].bj" size="5"></td>
    <td><input type="text" id="1403bj" name="classDutyList[3].bj" size="5"></td>
    <td><input type="text" id="1301bj" name="classDutyList[4].bj" size="5"></td>
    <td><input type="text" id="1302bj" name="classDutyList[5].bj" size="5"></td>
    <td><input type="text" id="1303bj" name="classDutyList[6].bj" size="5"></td>
	<td><input type="text" id="1402bj" name="classDutyList[7].bj" size="5"></td>
  </tr>
  <tr align="center" valign="middle">
    <td>无故缺勤</td>
    <td><input type="text" id="1102wgqq" name="classDutyList[0].wgqq" size="5"></td>
    <td><input type="text" id="1401wgqq" name="classDutyList[1].wgqq" size="5"></td>
    <td><input type="text" id="1202wgqq" name="classDutyList[2].wgqq" size="5"></td>
    <td><input type="text" id="1403wgqq" name="classDutyList[3].wgqq" size="5"></td>
    <td><input type="text" id="1301wgqq" name="classDutyList[4].wgqq" size="5"></td>
    <td><input type="text" id="1302wgqq" name="classDutyList[5].wgqq" size="5"></td>
    <td><input type="text" id="1303wgqq" name="classDutyList[6].wgqq" size="5"></td>
	<td><input type="text" id="1402wgqq" name="classDutyList[7].wgqq" size="5"></td>
  </tr>
  <tr align="center" valign="middle">
    ...
    <td><font color="red">双击弹出学生选择对话框</font><textarea id="1301qqrxm" name="classDutyList[4].wgqqxm" rows="20" cols="10"  ondblclick="tanchu('<%=request.getContextPath() %>/duty/tanchukuang1301.jsp');"  readonly="true">无缺勤</textarea></td>
    ...
    <td><font color="red">双击弹出学生选择对话框</font><textarea id="1303qqrxm" name="classDutyList[6].wgqqxm" rows="20" cols="10"  ondblclick="tanchu('<%=request.getContextPath() %>/duty/tanchukuang1303.jsp');"  readonly="true">无缺勤</textarea></td>
