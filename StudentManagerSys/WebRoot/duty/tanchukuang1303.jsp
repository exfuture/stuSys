...
<script language="javascript">
   function setValue()
   {
      ...
      window.opener.document.getElementById("1303qqrxm").value=studentNames;
      window.close();
   }
</script>
<body>
<table width="100%">
	...
	<tr>
	 <td>
	     ...
	     leftTitle="班级学生"     
	     list="{'杜松岩','万初琦','王可欣','苗磊','王紫涵','刘杨','东思微','周胜','周峻先','马成名','孙喜通','宫厚福','赵长福',
	            '孙贺贤','杨洋','刘斌','张卓','苗志强','葛佳星','石彦良','马治浩','李颜辉','穆敦'}" 
	     addToRightLabel="右移"  
	     addToLeftLabel="左移"  
